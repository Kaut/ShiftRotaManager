...
namespace ShiftRotaManager.Data.Data
{
    public static class DbInitializer
    {
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            {
                new() { Id = Guid.NewGuid(), FirstName = "Kautilya", LastName = "Shukla", Email = "kautilya.shukla@example.com", RoleId = engineerRole.Id, PreferredDaysOfWeek= PreferredDaysOfWeek1, PreferredShift = shifts[3] },
                new() { Id = Guid.NewGuid(), FirstName = "Bhromor", LastName = "Gayen", Email = "bhromor.gayen@example.com", RoleId = engineerRole.Id, PreferredDaysOfWeek=PreferredDaysOfWeek2, PreferredShift = shifts[2] },
                new() { Id = Guid.NewGuid(), FirstName = "Mikey", LastName = "Moore", Email = "mikey.moore@example.com", RoleId = managerRole.Id, PreferredDaysOfWeek=PreferredDaysOfWeek1, PreferredShift = shifts[1]  },
                new() { Id = Guid.NewGuid(), FirstName = "Abdul", LastName = "Rauf", Email = "abdul.rauf@example.com", RoleId = engineerRole.Id, PreferredDaysOfWeek=PreferredDaysOfWeek2, PreferredShift = shifts[2]  },
                new() { Id = Guid.NewGuid(), FirstName = "Abdul", LastName = "Razaq", Email = "abdul.razaq@example.com", RoleId = engineerRole.Id, PreferredDaysOfWeek=PreferredDaysOfWeek1, PreferredShift = shifts[0]  },
                new() { Id = Guid.NewGuid(), FirstName = "Sridhar", LastName = "Konda", Email = "sridhar.konda@example.com", RoleId = engineerRole.Id, PreferredDaysOfWeek=PreferredDaysOfWeek1, PreferredShift = shifts[2]  },
                new() { Id = Guid.NewGuid(), FirstName = "Udaya", LastName = "Arumugam", Email = "udaya.arumugam@example.com", RoleId = engineerRole.Id, PreferredDaysOfWeek=PreferredDaysOfWeek2, PreferredShift = shifts[3]  }
             };
