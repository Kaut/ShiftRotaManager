...
namespace ShiftRotaManager.Web.Controllers
{
    ...
    public class RotasController : Controller
    {
        ...
        public async Task<IActionResult> Create(DateTime? startDate, DateTime? endDate)
        {
            ...
            // If start and end dates are provided in the query string (e.g., from the calendar),
            // set them in the view model. This will pre-populate the date fields on the form.
